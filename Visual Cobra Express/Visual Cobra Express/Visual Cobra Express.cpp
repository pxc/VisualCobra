// Visual Cobra Express.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "Visual Cobra Express.h"
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	nRetVal = Start(lpCmdLine, L"Visual_Cobra_Express", nCmdShow, NULL, NULL);
